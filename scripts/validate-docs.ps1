...
$requiredFiles = @(
    ...
    'plugins/agents-for-star/skills/star-orchestrator/assets/star-agent.svg',
    'plugins/agents-for-star/skills/star-orchestrator/assets/star-agent-small.svg',
    'plugins/agents-for-star/skills/star-product-manager/SKILL.md',
    'plugins/agents-for-star/skills/star-product-manager/assets/star-agent.svg',
    'plugins/agents-for-star/skills/star-product-manager/assets/star-agent-small.svg',
