...
Use this skill when the user invokes /star-firmware or asks for Firmware Agent.

1. Read docs/agents/roles/firmware-agent.md.
...
4. Preferred review Agents: Hardware Architect Agent, Security Agent, QA Reliability Agent, Backend Agent.
...
firmware, OTA, state machine, logs, low power, secure boot, device input protocol
