...
Use this skill when the user invokes /star-marketing or asks for Marketing Agent.

1. Read docs/agents/roles/marketing-agent.md.
...
4. Preferred review Agents: Product Manager Agent, Sales Agent, Compliance Agent.
...
marketing, positioning, content, launch copy, claims review, public messaging
