...
Use this skill when the user invokes /star-knowledge-ops or asks for Knowledge Ops Agent.

1. Read docs/agents/roles/knowledge-ops-agent.md.
...
4. Preferred review Agents: CEO Strategy Agent, QA Reliability Agent, Compliance Agent.
...
knowledge ops, docs, decision records, audit logs, weekly review, goal prompt, fact source cleanup
