...
Use this skill when the user invokes /star-compliance or asks for Compliance Agent.

1. Read docs/agents/roles/compliance-agent.md.
...
4. Preferred review Agents: Security Agent, Product Manager Agent, App UX Agent.
...
privacy, compliance, certification, data retention, external claims, legal review questions
