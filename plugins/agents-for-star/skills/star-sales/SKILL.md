...
Use this skill when the user invokes /star-sales or asks for Sales Agent.

1. Read docs/agents/roles/sales-agent.md.
...
4. Preferred review Agents: Marketing Agent, Customer Success Agent, Product Manager Agent, Finance Agent.
...
sales, ICP, leads, demo, pipeline, customer email, quote, pilot agreement
