...
Use this skill when the user invokes /star-finance or asks for Finance Agent.

1. Read docs/agents/roles/finance-agent.md.
...
4. Preferred review Agents: CEO Strategy Agent, Supply Chain Agent, AI ML Agent.
...
finance, budget, cash flow, unit economics, payment approval, cost assumptions, runway
