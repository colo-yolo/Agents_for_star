...
Use this skill when the user invokes /star-app-ux or asks for App UX Agent.

1. Read docs/agents/roles/app-ux-agent.md.
...
4. Preferred review Agents: Product Manager Agent, Compliance Agent, Customer Success Agent.
...
UX, UI flow, approval interface, device status, risk copy, usability, customer-visible text
