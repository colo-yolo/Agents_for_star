...
Use this skill when the user invokes /star-product-manager or asks for Product Manager Agent.

1. Read docs/agents/roles/product-manager-agent.md.
...
4. Preferred review Agents: Customer Success Agent, Compliance Agent, QA Reliability Agent.
...
PRD, product requirements, user research, MVP scope, acceptance criteria, main scenario decisions
